...
public class DynamicContentItemVariant implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, variant.id)
        && Objects.equals(url, variant.url)
        && Objects.equals(content, variant.content)
        && Objects.equals(localeId, variant.localeId)
        && Objects.equals(outdated, variant.outdated)
        && Objects.equals(active, variant.active)
        && Objects.equals(isDefault, variant.isDefault)
        && Objects.equals(createdAt, variant.createdAt)
        && Objects.equals(updatedAt, variant.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        id, url, content, localeId, outdated, active, isDefault, createdAt, updatedAt);
  }
