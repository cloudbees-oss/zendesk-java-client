...
public class ArticleAttachments {
  ...
  /**
   * If true, the attached file is shown in the dedicated admin UI for inline attachments and its
   * url can be referenced in the HTML body of the article. If false, the attachment is listed in
   * the list of attachments. Default is false
   */
