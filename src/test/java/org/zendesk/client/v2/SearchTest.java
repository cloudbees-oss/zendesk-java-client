...
public class SearchTest {
  ...
  @Test
  public void getSearchResults_Sorting()
    ...
    zendeskApiMock.stubFor(
        get(urlPathEqualTo("/api/v2/search.json"))
            ...
            .willReturn(ok().withBody(objectMapper.writeValueAsString(searchResults))));

    Iterable<Ticket> actualResults =
        client.getSearchResults(Ticket.class, query, expectedSortBy, SortOrder.ASCENDING);
