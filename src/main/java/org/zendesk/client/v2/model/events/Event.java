...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = SurveyOfferedEvent.class, name = "SurveyOffered"),
  @JsonSubTypes.Type(value = SurveyResponseSubmittedEvent.class, name = "SurveyResponseSubmitted")
})
